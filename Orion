...
function OrionLib:MakeWindow(WindowConfig)
	...
	-- [移植設定] KeyToOpenWindow & FreeMouse
	...
	if typeof(WindowConfig.KeyToOpenWindow) == "string" then
		WindowConfig.KeyToOpenWindow = Enum.KeyCode[WindowConfig.KeyToOpenWindow]
	end
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		OrionLib:MakeNotification({
			...
			Content = "Tap " .. WindowConfig.KeyToOpenWindow.Name .. " to reopen the interface",
			Time = 5
		})
	...
	AddConnection(UserInputService.InputBegan, function(Input)
		if Input.KeyCode == WindowConfig.KeyToOpenWindow then
			SetUIVisibility(not MainWindow.Visible)
		end
	end)
...
function OrionLib:Destroy()
	UnlockMouse(false) -- [移植] 破棄時にロック解除を終了
	Orion:Destroy()
end
